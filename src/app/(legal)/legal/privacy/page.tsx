...
const PrivacyPage = () => {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p className="mb-4">
        Your privacy is important to us. It is SparkMind's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://sparkmind.com, and other sites we own and operate.
      </p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-navy">Legitimate Reasons for Processing Your Personal Information</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-navy">How Long We Keep Your Personal Information</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-navy">Disclosure of Personal Information to Third Parties</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4 text-navy">Your Rights and Controlling Your Personal Information</h2>
        <p className="mb-4">

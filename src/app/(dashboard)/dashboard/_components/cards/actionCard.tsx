    ...
    const data = [
      {
        ...
        description:
          'Investigate why the MR rate for the insect team is higher than the company-wide average. Consider factors like team size, project workload, and potential for improvement.',
        start: {
      ...
      },
      {
        ...
        description:
          'Check for any comments on the issue related to MR rate analysis. Determine if the analysis was helpful and identify any areas for improvement.',
        start: {
          dateTime: '2024-08-05T00:00:00+05:30',
          timeZone: 'Asia/Calcutta',
        },
            ...
            {showList.map((item, index) => (
              <div key={index} className="border-b pb-4">
                ...
                <p className="text-sm">
                  ...
                  {new Date(item.end.dateTime).toLocaleDateString()}
                </p>

...
import { z } from "zod";
import { Form, FormControl, FormLabel, FormDescription, FormField } from "@/components/ui/form"
...
export const NewNoteSection: React.FC<{ handleCreate: (values: z.infer<typeof schema>) => void, notes: z.infer<typeof schema>[] }> = ({ handleCreate, notes }) => {
        ...
        <DialogContent className="flex flex-col items-center justify-center bg-blue-500 rounded-lg p-8 w-[700px] h-[400px]">
          <div className="flex flex-col items-center justify-center w-full h-full">
            <div className="bg-transparent border-dashed border-2 border-white rounded-lg w-[150px] h-[100px] flex items-center justify-center">
              <FaPlus size={24} color="#ffffff" onClick={() => {

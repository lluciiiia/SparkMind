      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center ">
        ...
        <div className="px-6 sm:px-0 max-w-sm ">
          <button
            ...
            type="button"
            className="text-slate-900 w-full bg-slate-100 relative hover:bg-slate-200 focus:ring-4 focus:outline-none focus:ring-slate-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between mb-2 z-10">
        ...
        <div>
          <p className="mt-2 text-center text-sm text-gray-500">
            ...
            <a href="/signup" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 relative z-10">
              SignUp
            </a>
          </p>
        </div>
